...
\begin{DoxyCompactList}\small\item\em A getter for all the hash functions constants. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Definition at line 34 of file count\+\_\+sketch.\+h.
...
\DoxyCodeLine{71         \}}
\DoxyCodeLine{72 }
\DoxyCodeLine{73         ASSERT(this-\/>d == hashs\_consts.size());}
\DoxyCodeLine{74     }
...
\DoxyCodeLine{114         ASSERT(this-\/>d == hashs\_consts.size());}
\DoxyCodeLine{115 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{207                                                    \{}
\DoxyCodeLine{208         ASSERT(this-\/>t == rhs.t);}
\DoxyCodeLine{209         ASSERT(this-\/>d == rhs.d);}
\DoxyCodeLine{210 }
\DoxyCodeLine{211         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i < this-\/>d; i++)\{}
\DoxyCodeLine{212             ASSERT(this-\/>hash\_functions[i].get\_constants() == rhs.hash\_functions[i].get\_constants());}
\DoxyCodeLine{213         \}}
\DoxyCodeLine{214 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{188                                                       \{}
\DoxyCodeLine{189         ASSERT(this-\/>t == rhs.t);}
\DoxyCodeLine{190         ASSERT(this-\/>d == rhs.d);}
\DoxyCodeLine{191 }
\DoxyCodeLine{192         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i < this-\/>d; i++)\{}
\DoxyCodeLine{193             ASSERT(this-\/>hash\_functions[i].get\_constants() == rhs.hash\_functions[i].get\_constants());        }
\DoxyCodeLine{194         \}}
\DoxyCodeLine{195 }
