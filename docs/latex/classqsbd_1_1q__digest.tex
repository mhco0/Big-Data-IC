...
\begin{DoxyCompactList}\small\item\em Trys to compress the q\+\_\+digeste tree if possible. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Merges this instance of quadtree with another \mbox{\hyperlink{classqsbd_1_1q__digest}{q\+\_\+digest}} instance. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Merges this instance of quadtree with another \mbox{\hyperlink{classqsbd_1_1q__digest}{q\+\_\+digest}} instance and saves it in this instance. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classqsbd_1_1q__digest_a4ab1ac055cb586cc8af5f5eb40180e14}{get\+\_\+total\+\_\+weight}} () const
\begin{DoxyCompactList}\small\item\em Getter for the total weight saw the the instance. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Merges this instance of quadtree with another \mbox{\hyperlink{classqsbd_1_1q__digest}{q\+\_\+digest}} instance and saves it in this instance. 
...
Implements \mbox{\hyperlink{classqsbd_1_1quantile__sketch}{qsbd\+::quantile\+\_\+sketch$<$ int $>$}}.
...
Merges this instance of quadtree with another \mbox{\hyperlink{classqsbd_1_1q__digest}{q\+\_\+digest}} instance. 
...
Reimplemented from \mbox{\hyperlink{classqsbd_1_1quantile__sketch}{qsbd\+::quantile\+\_\+sketch$<$ int $>$}}.
...
\DoxyCodeLine{320             DEBUG\_ERR(\textcolor{stringliteral}{"{}On q\_digest::update value first parameter 'x' is greater then the universe range"{}});}
\DoxyCodeLine{321 }
...
\DoxyCodeLine{304             DEBUG\_ERR(\textcolor{stringliteral}{"{}On q\_digest::update value first parameter 'x' is greater then the universe range"{}});}
\DoxyCodeLine{305 }
