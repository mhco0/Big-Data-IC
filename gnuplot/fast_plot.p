...
plot gk_file  using (log10($1)):2 with linespoints title "gk", \
     dcs_file  using (log10($1)):2 with linespoints title "dcs", \
     q_digest_file  using (log10($1)):2 with linespoints title "q_digest", \
     kll_file  using (log10($1)):2 with linespoints title "kll"
