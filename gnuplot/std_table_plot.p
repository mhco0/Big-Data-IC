...
plot [5 : 8] gk_file_ct using (log10($1)):2:3 with yerrorbars title "gk", \
     dcs_file_ct using (log10($1)):2:3 with yerrorbars title "dcs", \
     q_digest_file_ct using (log10($1)):2:3 with yerrorbars title "q_digest", \
     kll_file_ct using (log10($1)):2:3 with yerrorbars title "kll"
...
plot [5 : 8] gk_file_ut using (log10($1)):2:3 with yerrorbars title "gk", \
     dcs_file_ut using (log10($1)):2:3 with yerrorbars title "dcs", \
     q_digest_file_ut using (log10($1)):2:3 with yerrorbars title "q_digest", \
     kll_file_ut using (log10($1)):2:3 with yerrorbars title "kll"
...
plot gk_file_qt using (log10($1)):2:3 with yerrorbars title "gk", \
     dcs_file_qt using (log10($1)):2:3 with yerrorbars title "dcs", \
     q_digest_file_qt using (log10($1)):2:3 with yerrorbars title "q_digest", \
     kll_file_qt using (log10($1)):2:3 with yerrorbars title "kll"
